...
## Not sure why we only put labels on some axes and not others, but I'm just following the instructions!
par(mfrow=c(2,2))
with(powert,plot(datetime,Global_active_power,type="l",xlab="",ylab="Global Active Power"))
with(powert,plot(datetime,Voltage,type="l",xlab="datetime",ylab="Voltage"))
...
with(powert,plot(datetime,Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power"))
dev.off()